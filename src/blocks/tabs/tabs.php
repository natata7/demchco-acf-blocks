...
$abs_defaults = array(
	'class'               => array( 'demchco-block', 'demchco-block-tabs' ),
...
$abs_tabs = ! empty( $abs_defaults['fields'] ) ? $abs_defaults['fields'] : get_acf_fields( array( 'tab_items' ), $block['id'] );
?>

<?php if ( ! empty( $block['data']['_is_preview'] ) ) : ?>
	<figure>
		<img
			src="<?php echo esc_url( plugin_dir_url( __DIR__ ) . '../assets/images/block-previews/tabs-preview.jpg' ); ?>"
			alt="<?php esc_html_e( 'Preview of the Tabs Block', 'demchco' ); ?>"
		>
	</figure>
