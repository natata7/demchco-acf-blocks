...
$abs_defaults = array(
	'class'               => array( 'demchco-block', 'demchco-block-cards-repeater' ),
...
$abs_cards = ! empty( $abs_defaults['fields'] ) ? $abs_defaults['fields'] : get_acf_fields( array( 'card' ), $block['id'] );
?>

<?php if ( ! empty( $block['data']['_is_preview'] ) ) : ?>
	<figure>
		<img
			src="<?php echo esc_url( plugin_dir_url( __DIR__ ) . '../assets/images/block-previews/cards-repeater-preview.jpg' ); ?>"
			alt="<?php esc_html_e( 'Preview of the Manual Cards Block', 'demchco' ); ?>"
		>
	</figure>
